...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          _selectedIndex == 0 ? "Todos" :
          _selectedIndex == 1 ? "Calendar ${DateTime.now().year}":"Profile"
        ),
        centerTitle: true,
                          ...
                          return Column(
                            children: [
                              ClipRRect(
                                ...
                                child: Container(
                                  color: context.watch<TodoProvider>().isDark ? Color(0xff0e0e0e) : Colors.white,
                                  child: ExpansionTile(
                                    title: Text(
                                    ...
                                    leading: Theme(
                                      ...
                                      child: Checkbox(
                                        ...
                                        shape: RoundedRectangleBorder(
                                          side: BorderSide(
                                              width: 1.0, color: Color(int.parse(returnUnfinishedTodo()![index]['color']!))
                                          ),
                                        ),
                                    ...
                                    childrenPadding: EdgeInsets.symmetric(vertical: 10,horizontal: 62),
                                    ...
                                    child: ExpansionTile(
                                      ...
                                      leading: Theme(
                                        ...
                                        child: Checkbox(
                                          ...
                                          shape: RoundedRectangleBorder(
                                            side: BorderSide(
                                                width: 1.0, color: Color(int.parse(returnFinishedTodo()![index]['color']!))
                                            ),
                                          ),
                                          checkColor: Colors.white,
                                          onChanged: (val){
                ...
                child: Row(
                  children: [
                    ChoiceChip(
                      label: Text("Routine"),
                      selected: isRoutine,
                      backgroundColor: context.watch<TodoProvider>().isDark ? Color(0xff1a1a1a) : Colors.white,
                      selectedColor: Colors.deepOrange,
                      padding: EdgeInsets.symmetric(horizontal: 10),
                      side: BorderSide(color: isRoutine ? Colors.white : Colors.deepOrange),
                      labelStyle: TextStyle(
                          color: isRoutine ? Colors.white : Colors.deepOrange
                      ),
                      onSelected: (bool val){
                        setState((){
                          isRoutine = val;
                    ...
                    ChoiceChip(
                      ...
                      labelStyle: TextStyle(
                          color: isWork ? Colors.white : Colors.blue
                      ),
                      onSelected: (bool val){
                        setState((){
                          isRoutine = false;
                    ...
                    ChoiceChip(
                      ...
                      labelStyle: TextStyle(
                          color: isOthers ? Colors.white : Colors.green
                      ),
                      onSelected: (bool val){
                        setState((){
                          isRoutine = false;
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        backgroundColor: context.watch<TodoProvider>().isDark ? Color(0xff1a1a1a) : Color(0xfff0f0f0),
                        ...
                        builder: (context, child) {
                          return Theme(
                            data: Theme.of(context).copyWith(
                              dialogBackgroundColor: context.watch<TodoProvider>().isDark ? Color(0xff0e0e0e) : Colors.white,
                ...
                SizedBox(
                  ...
                  child: OutlinedButton(
                    ...
                    style: OutlinedButton.styleFrom(
                      padding: EdgeInsets.all(20),
                      side: BorderSide(
                        color: context.watch<TodoProvider>().isDark ? Colors.white : Colors.blue
                      )
                    ),
                  )
                ),
                    ...
                    onPressed: (){
                      setState((){
                        context.read<TodoProvider>().isiTodo = {
                          ...
                          'color': value.toString() == "Routine" ? "0xffff5722" : value.toString() == "Work" ? "0xff2196f3" : "0xff4caf50"
                        };
                        Navigator.of(context).pop();
                      });
                      showDialog(
                        ...
                        builder: (BuildContext context){
                          return Dialog(
                            backgroundColor: context.watch<TodoProvider>().isDark ? Color(0xff0e0e0e) : Colors.white,
                            shape: RoundedRectangleBorder(
