                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            style: TextStyle(
                                color: categories[index] == "Routine" ? Colors.deepOrange :
                                categories[index] == "Work" ? Colors.blue : Colors.green,
                                fontSize: 60
                            ),
                          ),
                          Text(
                  ...
                  children: [
                    SliderTheme(
                      ...
                      child: Slider(
                        ...
                        max: (context.watch<TodoProvider>().filteredItems("",false).length + context.watch<TodoProvider>().filteredItems("",true).length).toDouble(),
                        onChanged: null,
                      ),
                    ),
                    SizedBox(height: 20),
                    Text(
                      ...
                      "You still have ${context.watch<TodoProvider>().filteredItems("",false).length.toInt()} task(s) to do" : "All tasks done",
                      style: TextStyle(
                        color: context.watch<TodoProvider>().isDark ? Colors.white : Colors.black
                      ),
                    ),
